...
本文的輸入法選單、偏好設定與候選字實拍取自本機 **1.3.0 開發版**；目前公開安裝包仍是 **v1.2.9**，實際選單項目可能不同。
...
*圖 3：1.3.0 開發版在文件中選字的實拍。候選字左邊的數字是選字鍵，紫色列是目前反白的字；底部的 `1/4` 表示目前是第 1 頁、共 4 頁。*
...
*圖 4：1.3.0 開發版的輸入法選單；勾選記號表示目前正在使用「好打注音」。*
