...
*/
#define	PLIST_GLOBAL_FILENAME	@"io.github.polobread.chichi77.plist"
/*!
...
*/
#define	PLIST_PHONETIC_FILENAME	@"io.github.polobread.chichi77.TraditionalMandarin.plist"
/*!
	@define PLIST_SMARTPHONETIC_FILENAME
	@abstract The file name of the plist file for settings of the 
	Smart Phonetic Input Method.
*/
#define	PLIST_SMARTPHONETIC_FILENAME	@"io.github.polobread.chichi77.SmartMandarin.plist"
/*!
	@define PLIST_CANGJIE_FILENAME
	@abstract The file name of the plist file for settings of the 
	Cangjie Phonetic Input Method.
*/
#define	PLIST_CANGJIE_FILENAME	@"io.github.polobread.chichi77.Generic-cj-cin.plist"
/*!
	@define PLIST_SIMPLEX_FILENAME
	@abstract The file name of the plist file for settings of the 
	Simplex Phonetic Input Method.
*/
#define	PLIST_SIMPLEX_FILENAME	@"io.github.polobread.chichi77.Generic-simplex-cin.plist"
#define PLIST_SEARCH_FILENAME	@"io.github.polobread.chichi77.OneKey.plist"
#define	PLIST_GENERIC_FILENAME(x)	[NSString stringWithFormat:@"io.github.polobread.chichi77.%@.plist", x]
#define PLIST_WORDCOUNT_FILENAME	@"io.github.polobread.chichi77.YKAFWordCount.plist"

/*!
	@define CACHE_FOLDER
	@abstract The name of the cache folder
*/
#define CACHE_FOLDER	@"io.github.polobread.chichi77"
/*!
