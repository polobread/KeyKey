...
def make_dmg():
	...
	arg = [command, "create",  "-sectors", str(size), "-volname", disk, "-attach", "-fs", "HFS+", "chichi77-OSX-DB.dmg"]
	...
	command = "hdiutil convert chichi77-OSX-DB.dmg -format UDZO -imagekey zlib-level=9 -o " + dmg
	os.system(command)
...
def main():
	...
	make_dmg()
	os.system("sudo rm -rf " + pkg)
	os.system("sudo rm -rf chichi77-OSX-DB.dmg")
