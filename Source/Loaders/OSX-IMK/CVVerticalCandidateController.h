...
@interface CVVerticalCandidateController : NSWindowController <NSTableViewDataSource, NSTableViewDelegate>
{
	...
	NSArray *_displayedCandidateTexts;
	size_t _displayedPage;
	size_t _displayedHighlightIndex;
	BOOL _displayedInControl;
