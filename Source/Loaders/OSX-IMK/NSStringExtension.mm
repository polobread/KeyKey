...
{	
	...
	return [NSString stringWithFormat:@"%f %f %f", [convertedColor redComponent], [convertedColor greenComponent], [convertedColor blueComponent]];
}
- (NSColor *)colorByString
{
	...
	return [NSColor colorWithCalibratedRed:[[s objectAtIndex:0] floatValue] green:[[s objectAtIndex:1] floatValue] blue:[[s objectAtIndex:2] floatValue] alpha:1.0];
}
...
- (NSString *)stringByChomping
{
    ...
    NSRange r = (NSRange){0, (NSUInteger)(i + 1)};
